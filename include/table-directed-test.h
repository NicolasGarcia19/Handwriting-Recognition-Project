...
void test_case_find_closest(int test_case_num, Func f, DistFunc dist,
                            HashFunc hash) {
  std::printf("\n%d: %s\n", test_case_num, __func__);
  ...
  T data[] = {
      f(10), f(60), f(110), f(210), f(20), f(70), f(120), f(220),
      f(30), f(80), f(130), f(230), f(40), f(90), f(140), f(240),
  };
...
template <typename T, typename Func, typename DistFunc, typename HashFunc>
void test_case_find_closest_empty(int test_case_num, Func f, DistFunc dist,
                                  HashFunc hash) {
  std::printf("\n%d: %s\n", test_case_num, __func__);
  ...
  T data[] = {
      f(10), f(60), f(110), f(210), f(20), f(70), f(120), f(220),
      f(30), f(80), f(50),  f(230), f(40), f(90), f(250), f(240),
  };
...
void test_case_to_vector_rehash(int test_case_num, Func f, HashFunc hash) {
  ...
  T data[] = {f(10),  f(20), f(90),  f(30), f(200), f(100), f(15), f(230),
              f(240), f(5),  f(101), f(21), f(160), f(31),  f(6)};
