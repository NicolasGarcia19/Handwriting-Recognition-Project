...
void test_case_find_closest_balanced_largeK(int test_case_num, Func f,
                                            CmpFunc cmp, DistFunc dist) {
  std::printf("\n%d: %s\n", test_case_num, __func__);

  Tree<T, CmpFunc> tree(1024, cmp);

  T data[] = {f(80), f(40), f(120), f(20), f(60),  f(100), f(140), f(10),
              f(30), f(50), f(70),  f(90), f(110), f(130), f(150)};
  for (T v : data)
    tree.add(v);
...
void test_case_to_vector_unbalanced(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T data[] = {f(80),  f(70), f(90),  f(60), f(100), f(50), f(110), f(40),
              f(120), f(30), f(130), f(20), f(140), f(10), f(150)};
  for (T v : data)
    tree.add(v);
...
void test_case_to_vector_funky(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T data[] = {f(80), f(60),  f(40),  f(20),  f(10),  f(30),  f(50), f(70),
              f(90), f(150), f(100), f(140), f(110), f(130), f(120)};
  for (T v : data)
    tree.add(v);
...
template <typename T, typename Func, typename CmpFunc, typename DistFunc>
void test_case_two_nodes(int test_case_num, Func f, CmpFunc cmp,
                         DistFunc dist) {
  std::printf("\n%d: %s\n", test_case_num, __func__);
...
template <typename T, typename Func, typename CmpFunc, typename DistFunc>
void test_case_three_nodes(int test_case_num, Func f, CmpFunc cmp,
                           DistFunc dist) {
  std::printf("\n%d: %s\n", test_case_num, __func__);
  ...
  int perms[6][3] = {{1, 5, 9}, {5, 1, 9}, {5, 9, 1},
                     {1, 9, 5}, {9, 1, 5}, {9, 5, 1}};
...
template <typename T, typename Func, typename CmpFunc, typename DistFunc>
void test_case_four_nodes(int test_case_num, Func f, CmpFunc cmp,
                          DistFunc dist) {
  std::printf("\n%d: %s\n", test_case_num, __func__);
  ...
  int perms[24][4] = {
      {1, 15, 30, 7}, {1, 15, 7, 30}, {1, 30, 15, 7}, {1, 30, 7, 15},
      {1, 7, 15, 30}, {1, 7, 30, 15}, {15, 1, 30, 7}, {15, 1, 7, 30},
      {15, 30, 1, 7}, {15, 30, 7, 1}, {15, 7, 30, 1}, {15, 7, 1, 30},
      {30, 1, 15, 7}, {30, 1, 7, 15}, {30, 15, 1, 7}, {30, 15, 7, 1},
      {30, 7, 15, 1}, {30, 7, 1, 15}, {7, 1, 15, 30}, {7, 1, 30, 15},
      {7, 15, 1, 30}, {7, 15, 30, 1}, {7, 30, 15, 1}, {7, 30, 1, 15}};
