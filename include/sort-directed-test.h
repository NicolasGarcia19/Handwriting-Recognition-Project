...
void test_case_helper(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T arr[5] = {f(5), f(4), f(3), f(2), f(1)};

  int pivot_index = partition(arr, 0, 5, cmp);

  T pivot = arr[pivot_index];

  for (int i = 0; i < pivot_index; i++) {
    ECE2400_CHECK_TRUE(cmp(arr[i], pivot) ||
                       (!cmp(pivot, arr[i]) && !cmp(arr[i], pivot)));
  }
  for (int i = pivot_index + 1; i < 5; i++) {
    ECE2400_CHECK_TRUE(cmp(pivot, arr[i]));
  }
}
...
void test_case_even_size_array(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(17), f(36), f(20), f(59), f(18), f(39), f(84), f(43),
            f(87), f(25), f(63), f(69), f(31), f(50), f(86), f(34)};
  T a0_ref[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39),
                f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  sort(a0, 16, cmp);
  for (int i = 0; i < 16; i++)
    ECE2400_CHECK_TRUE(a0[i] == a0_ref[i]);

  T a1[] = {f(58), f(29), f(16), f(6), f(7),  f(3), f(9),  f(0),
            f(5),  f(8),  f(15), f(1), f(28), f(2), f(74), f(4)};
  T a1_ref[] = {f(0), f(1), f(2),  f(3),  f(4),  f(5),  f(6),  f(7),
                f(8), f(9), f(15), f(16), f(28), f(29), f(58), f(74)};
  sort(a1, 16, cmp);
  for (int i = 0; i < 16; i++)
    ECE2400_CHECK_TRUE(a1[i] == a1_ref[i]);
}
...
void test_case_odd_size_array(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(17), f(36), f(20), f(59), f(18), f(39), f(84), f(43), f(87),
            f(25), f(63), f(69), f(31), f(50), f(86), f(34), f(42)};
  T a0_ref[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39), f(42),
                f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  sort(a0, 17, cmp);
  for (int i = 0; i < 17; i++)
    ECE2400_CHECK_TRUE(a0[i] == a0_ref[i]);

  T a1[] = {f(58), f(29), f(16), f(6),  f(7), f(3),  f(9), f(0), f(5),
            f(8),  f(15), f(1),  f(28), f(2), f(74), f(4), f(42)};
  T a1_ref[] = {f(0), f(1),  f(2),  f(3),  f(4),  f(5),  f(6),  f(7), f(8),
                f(9), f(15), f(16), f(28), f(29), f(42), f(58), f(74)};
  sort(a1, 17, cmp);
  for (int i = 0; i < 17; i++)
    ECE2400_CHECK_TRUE(a1[i] == a1_ref[i]);
}
...
void test_case_almost_sorted(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(17), f(18), f(20), f(25), f(31), f(50), f(36), f(39), f(42),
            f(43), f(34), f(59), f(63), f(69), f(84), f(86), f(87)};
  T a0_ref[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39), f(42),
                f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  sort(a0, 17, cmp);
  for (int i = 0; i < 17; i++)
  ...
  T a1[] = {f(0), f(1), f(2),  f(3),  f(4),  f(15), f(6),  f(7), f(8),
            f(9), f(5), f(16), f(28), f(29), f(42), f(58), f(74)};
  T a1_ref[] = {f(0), f(1),  f(2),  f(3),  f(4),  f(5),  f(6),  f(7), f(8),
                f(9), f(15), f(16), f(28), f(29), f(42), f(58), f(74)};
  sort(a1, 17, cmp);
  for (int i = 0; i < 17; i++)
...
void test_case_sorted_ascending(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39), f(42),
            f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  T a0_ref[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39), f(42),
                f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  sort(a0, 17, cmp);
  ...
  T a1[] = {f(0), f(1),  f(2),  f(3),  f(4),  f(5),  f(6),  f(7), f(8),
            f(9), f(15), f(16), f(28), f(29), f(42), f(58), f(74)};
  T a1_ref[] = {f(0), f(1),  f(2),  f(3),  f(4),  f(5),  f(6),  f(7), f(8),
                f(9), f(15), f(16), f(28), f(29), f(42), f(58), f(74)};
  sort(a1, 17, cmp);
...
void test_case_sorted_descending(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(87), f(86), f(84), f(69), f(63), f(59), f(50), f(43), f(42),
            f(39), f(36), f(34), f(31), f(25), f(20), f(18), f(17)};
  T a0_ref[] = {f(17), f(18), f(20), f(25), f(31), f(34), f(36), f(39), f(42),
                f(43), f(50), f(59), f(63), f(69), f(84), f(86), f(87)};
  sort(a0, 17, cmp);
  for (int i = 0; i < 17; i++)
  ...
  T a1[] = {f(74), f(58), f(42), f(29), f(28), f(16), f(15), f(9), f(8),
...
void test_case_few_unique(int test_case_num, Func f, CmpFunc cmp) {
  ...
  T a0[] = {f(2), f(2), f(0), f(3), f(1), f(2), f(2), f(1), f(0),
            f(1), f(1), f(1), f(1), f(1), f(1), f(1), f(0)};
  T a0_ref[] = {f(0), f(0), f(0), f(1), f(1), f(1), f(1), f(1), f(1),
                f(1), f(1), f(1), f(2), f(2), f(2), f(2), f(3)};
  sort(a0, 17, cmp);
  for (int i = 0; i < 17; i++)
    ECE2400_CHECK_TRUE(a0[i] == a0_ref[i]);

  T a1[] = {f(0), f(0), f(0), f(0), f(0), f(1), f(0), f(1), f(0),
            f(1), f(1), f(0), f(1), f(0), f(0), f(0), f(0)};
  T a1_ref[] = {f(0), f(0), f(0), f(0), f(0), f(0), f(0), f(0), f(0),
                f(0), f(0), f(0), f(1), f(1), f(1), f(1), f(1)};
  sort(a1, 17, cmp);
  for (int i = 0; i < 17; i++)
    ECE2400_CHECK_TRUE(a1[i] == a1_ref[i]);
}
